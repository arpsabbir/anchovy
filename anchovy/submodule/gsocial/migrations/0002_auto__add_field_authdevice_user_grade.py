...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthDevice.user_grade'
        db.add_column('gsocial_authdevice', 'user_grade', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AuthDevice.user_grade'
        db.delete_column('gsocial_authdevice', 'user_grade')
